  ...
  <div class="bg-gray-100 min-h-screen p-6 sm:p-10 text-gray-900">
    <div class="max-w-7xl mx-auto">
      ...
      <header class="flex flex-col items-center py-10">
        <h1 class="text-7xl font-bold text-center">Gestión de Usuarios</h1>
        <p class="text-gray-600 mt-3 text-center text-2xl">Gestiona usuarios de forma fácil y segura.</p>
